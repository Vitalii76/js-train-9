...
function findLastEvenNumber(arr) {
  ...
  if (Array.isArray(arr)) {
    const last = arr.findLast((element) => element % 2 === 0);
    if (last === undefined) {
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  if (Array.isArray(arr)) {
    ...
    return arrNew
      ...
      .filter((element1) => element1 > threshold);
  } else {
    return "Вхідний параметр має бути масивом";
  }
}
...
function flattenArray(arr) {
  ...
  if (Array.isArray(arr)) {
    const arrNew = arr.flat(Infinity);
    return arrNew;
  } else {
    return "Вхідний параметр має бути масивом";
  }
...
function expandArrayByN(arr, n) {
  ...
  if (Array.isArray(arr)) {
    return arr.flatMap((num) => [num, num, num]);
  } else {
    return "Вхідний параметр має бути масивом";
  }
}
